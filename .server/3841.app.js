...
const data = {
  ...
  "headers": [
    ...
    {
      "level": 2,
      "title": "零知识证明（zero knowledge validation）",
      "slug": "零知识证明-zero-knowledge-validation",
      "children": []
    },
    {
      "level": 2,
  ...
  "filePathRelative": "algorithm/digital_certificate.md",
  "git": {
    "contributors": [
      {
        "name": "yaomin",
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ digital_certificate_html)
});
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./docs/.vuepress/.temp/pages/algorithm/digital_certificate.html.vue?vue&type=template&id=33210c81
...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h1 id="数字证书" tabindex="-1"><a class="header-anchor" href="#数字证书" aria-hidden="true">#</a> 数字证书</h1><nav class="table-of-contents"><ul><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#定义" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`定义`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("定义")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#函数加密" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`函数加密`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("函数加密")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#零知识证明-zero-knowledge-validation" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`零知识证明（zero knowledge validation）`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("零知识证明（zero knowledge validation）")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#简介" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`简介`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("简介")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#历史" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`历史`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("历史")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#山寨币" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`山寨币`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("山寨币")
        ]
      }
    }),
    _: 1
  ...
  _push(`</li><li>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "#原理和设计" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`原理和设计`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("原理和设计")
        ]
      }
    }),
    _: 1
